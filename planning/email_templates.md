...
**Note:** The `{{STATUS_CHANGES_LIST}}` token is replaced with a formatted list generated by the code. Each item appears as:
```
• **Project Name** - Status changed to: **New Status**
  Project ID: XXXX-XX_XX-XXXX | View Project Folder: [URL]
```
